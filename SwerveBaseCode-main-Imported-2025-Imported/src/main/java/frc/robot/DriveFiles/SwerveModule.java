...
public class SwerveModule extends SubsystemBase{
  ...
  //initalize all variables
    ...
    public static SparkMax driveMotor;
    public final SparkClosedLoopController turningPidController;

    public static SparkBaseConfig driveGains;
  ...
  double absoluteEncoderOffsetRad, Boolean absoluteEncoderReversed) {
    ...
    driveGains.inverted(invertDrive);
    //driveGains.setOpenLoopRampRate(RAMP_RATE);
    driveGains.idleMode(IdleMode.kBrake);
     
    steerMotor.configure(steerGains, ResetMode)
